    ...
    return (
        <div className={`lg:grid lg:grid-cols-2 ${theme === "dark" ? "bg-slate-950" : "bg-slate-gray-200"}`}>
            ...
            <div className="h-[100vh] w-full flex flex-col items-center justify-center">
                ...
                <p className="font-poppins text-5xl  mt-2">Staff Dashboard </p>
                <Form method="post" className="mt-20">
                    ...
                    <p className="text-md font-poppins text-center mt-10">Do not have an account <Link to="/staff/registration"><span className="text-primary">Sign Up</span></Link></p>
...
export const action: ActionFunction = async ({ request }) => {
    ...
    const signin = await login.StaffLogin(request, email, password)
